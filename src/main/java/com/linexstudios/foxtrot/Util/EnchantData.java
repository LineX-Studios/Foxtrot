...
public class EnchantData {
    ...
    public String getFormattedName() {
        ...
        switch (this.rawKey.toLowerCase()) {
            ...
            case "megalongbow":
                cleanName = "MLB";
                color = EnumChatFormatting.LIGHT_PURPLE.toString();
                break;
            case "telebow":
                cleanName = "Telebow";
            ...
            case "singularity":
                ...
                break;
            case "fractional_reserve":
                cleanName = "Frac";
                color = EnumChatFormatting.BLUE.toString();
                break;
            case "critically_funky":
                cleanName = "Crit Funky";
                color = EnumChatFormatting.DARK_AQUA.toString();
                break;
            case "protection":
                cleanName = "Prot";
                color = EnumChatFormatting.BLUE.toString();
