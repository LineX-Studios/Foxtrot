...
public class CommandFoxtrot extends CommandBase {
    ...
    @Override public List<String> addTabCompletionOptions(ICommandSender s, String[] args, BlockPos pos) {
        if(args.length==1) return getListOfStringsMatchingLastWord(args, "friend","f","teammate","team","t","guild","g","add","remove","list","alerts","toggle","clear","denick","debug","esp","autodenick","hud","nickhud","enemyhud","denickentry","rank","focus","nickname","nick","ring","deadlobby","venom","enchantnames","nonhighlighter");
